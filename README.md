...
- Also I would add some information on how actually to play the game, as some individuals testing the game were a bit confused when starting to play. 
- The bot is also not optimized. I would need to look up on how to improve it.
